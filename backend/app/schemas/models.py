...
class DistrictData(BaseModel):
    ...
    pct_outdoor_workers: float = Field(
        ...,
        ge=0, le=100,
        description="Percentage of outdoor/manual laborers"
    )
    ...
    pct_vulnerable_social: float = Field(
        ...,
        ge=0, le=100,
        description="Percentage of vulnerable social groups"
    )
...
class AnalysisResponse(BaseModel):
    ...
    source_documents: List[SourceDocument] = Field(
        ...
        description="Source documents used for generating advice"
    )
